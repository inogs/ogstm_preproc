...
!C
      ...
      REAL(4), allocatable :: ssh16(:,:),ssht16(:,:),  sshu16(:,:),sshv16(:,:)
      REAL(8), allocatable :: ssh16t_R8(:,:),ssh16u_R8(:,:),ssh16v_R8(:,:)
...
!C
       ...
       allocate(ssht16(jpi16,jpj16))
       allocate(sshu16(jpi16,jpj16))
       allocate(sshv16(jpi16,jpj16))
       allocate(ssh16t_R8(jpi16,jpj16))
       allocate(ssh16u_R8(jpi16,jpj16))
       allocate(ssh16v_R8(jpi16,jpj16))
